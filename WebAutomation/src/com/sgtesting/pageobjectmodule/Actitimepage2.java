...
public class Actitimepage2 {
	...
	//user1click
	@FindBy(xpath = "//span[text()='user1, dummy']")
	private WebElement user77click;
	public WebElement getuser77click()
	{
		return user77click;
	}
	//user2click
	@FindBy(xpath = "//span[text()='user2, dummy']")
	private WebElement user88click;
	public WebElement getuser88click()
	{
		return user88click;
	}
	//user3click
	@FindBy(xpath = "//span[text()='user3, dummy']")
	private WebElement user99click;
	public WebElement getuser99click()
	{
		return user99click;
	}
}
